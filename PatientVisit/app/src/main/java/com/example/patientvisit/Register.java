        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (email_.isEmpty()) {
                    ...
                    mFirebaseAuth.createUserWithEmailAndPassword(email_, j).addOnCompleteListener(Register.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (!task.isSuccessful()) {
                                Toast.makeText(Register.this, "Please try again!!", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(Register.this, "Your record has been saved successfully!!", Toast.LENGTH_SHORT).show();
